...
// Ensure CMake OPUS_COMPLEXITY variable is supported
...
// --- RESTORED: State Data array and setter for main.cpp ---
...
void audio_loop() {
    ...
    for (int i = 0; i < out_frames; i++) {
        ...
        // FIX: Replaced 'haptics_buffer_length' with 'audio_buffer_length' to match config.h
        ...
        // RESTORED: Insert state_data back into the packet payload
        pkt[11] = 0x10 | 0 << 6 | 1 << 7;
        pkt[12] = 63;
...
void core1_entry() {
    ...
    // RESTORED: Use the CMake parameter for complexity
